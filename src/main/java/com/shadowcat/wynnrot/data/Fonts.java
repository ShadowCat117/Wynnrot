...
public record Fonts(Identifier identifier, List<String> characters) {
  private static final Identifier PORTRAIT_FONT =
      Identifier.withDefaultNamespace("hud/dialogue/portrait");

  public static final Fonts FRUMA_QUEEN_67 =
      new Fonts(
          Identifier.fromNamespaceAndPath("wynnrot", "hud/dialogue/portrait"),
          List.of("\uE000", "\uE001", "\uE002", "\uE003", "\uE004", "\uE005", "\uE006", "\uE007"));
  public static final Fonts RIGHT_SUI =
      new Fonts(
          PORTRAIT_FONT,
          List.of(
              "\uE170", "\uE171", "\uE172", "\uE173", "\uE174", "\uE175", "\uE176", "\uE177",
              ...
              "\uE2B0", "\uE2B1", "\uE2B2", "\uE2B3", "\uE2B4", "\uE2B5", "\uE2B6", "\uE2B7",
              "\uE2B8", "\uE2B9"));
  public static final Fonts RIGHT_SUI_EATING =
      new Fonts(PORTRAIT_FONT, List.of("\uE17A", "\uE17B"));
  public static final Fonts LEFT_SUI =
      new Fonts(
          PORTRAIT_FONT,
          List.of(
              "\uE180", "\uE181", "\uE182", "\uE183", "\uE184", "\uE185", "\uE186", "\uE187",
  ...
  public static Map<String, String> PREFIX_OFFSETS =
      Map.ofEntries(
          Map.entry("\uE170", "\uDAFF\uDFFF"),
          Map.entry("\uE171", "\uDAFF\uDFFF"),
          Map.entry("\uE172", "\uDB00\uDC02"),
  ...
  public static Map<String, String> SUFFIX_OFFSETS =
      Map.ofEntries(
          Map.entry("\uE170", "\uDB00\uDC01"),
          Map.entry("\uE174", "\uDB00\uDC02"),
          Map.entry("\uE176", "\uDB00\uDC01"),
