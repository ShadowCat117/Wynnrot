    ...
    return parent -> {
      ConfigBuilder configBuilder =
          ConfigBuilder.create()
              ...
              .setTitle(Component.translatable("wynnrot.config"));
      ConfigEntryBuilder entryBuilder = configBuilder.entryBuilder();

      // region Portraits
      ConfigCategory portraits =
          configBuilder.getOrCreateCategory(
              Component.translatable("wynnrot.config.category.portraits"));

      portraits.addEntry(
          entryBuilder
              .startBooleanToggle(
                  Component.translatable("wynnrot.config.sixSevenQueen.name"),
                  WynnrotConfig.sixSevenQueen())
      ...
      portraits.addEntry(
          entryBuilder
              ...
              .setDefaultValue(2)
              .setTooltip(
                  Component.translatable("wynnrot.config.sixSevenQueenUpdateRate.description"))
      ...
      portraits.addEntry(
          entryBuilder
              ...
              .setDefaultValue(4)
              .setTooltip(
                  Component.translatable("wynnrot.config.eternalHungerSuiUpdateRate.description"))
      ...
      chat.addEntry(
          entryBuilder
              .startBooleanToggle(
                  Component.translatable("wynnrot.config.meow.name"), WynnrotConfig.meow())
              .setDefaultValue(true)
      ...
      ConfigCategory titles =
          configBuilder.getOrCreateCategory(
              Component.translatable("wynnrot.config.category.titles"));

      titles.addEntry(
          entryBuilder
              .startBooleanToggle(
                  Component.translatable("wynnrot.config.leBigFish.name"),
                  WynnrotConfig.leBigFish())
              .setDefaultValue(true)
