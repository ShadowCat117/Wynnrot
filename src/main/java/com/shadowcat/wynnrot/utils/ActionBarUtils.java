...
public final class ActionBarUtils {
    ...
    original.visit(
        (style, text) -> {
          if (originalCharacters.contains(text)
            ...
            copy.append(
                Component.literal(replacementCharacter).withStyle(style.withFont(replacementFont)));
  ...
  public static Component replaceCharactersAnimated(
    ...
    return replaceCharacters(
        original, originalCharacters, replacementCharacter, originalFont, replacementFont);
  }
}
